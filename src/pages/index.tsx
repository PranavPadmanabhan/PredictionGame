...
export default function HomePage() {
  ...
  return (
    <div className='relative flex h-screen w-screen flex-col items-center justify-start overflow-hidden bg-backgroundColor pt-[13vh] lg:justify-center lg:pt-0'>
      {/* <Seo templateTitle='Home' /> */}
      <Seo />
      <Header className='pr-[2%]' />
      <Lottie
        className='absolute bottom-0 -mt-3 -mb-[30%] h-[78%] w-[140%] lg:right-0 lg:mb-0 lg:mt-0 lg:h-[80%] lg:w-[60%]'
      ...
      <div className='z-[100] flex h-[40%] w-full flex-col items-center justify-center px-10 lg:h-[50%] lg:items-start xxl3100:px-[200px]'>
        ...
        <p className='my-5 ml-1 text-center font-poppins text-[0.9rem] font-[300] tracking-tight text-white lg:my-8 lg:text-left lg:text-[1.2rem] lg:leading-7 xl1400:my-8 xl1400:text-[1.5rem] xl1400:leading-8 xxl3100:my-[100px] xxl3100:text-[3rem] xxl3100:leading-[70px]'>
