  ...
  return (
    <div className='relative flex h-screen w-screen flex-col items-center justify-center overflow-hidden bg-backgroundColor'>
      ...
      <div className='z-[100] flex h-[50%] w-full flex-col items-start justify-center px-10 xxl3100:px-[200px] '>
        <h1 className='font-poppins text-[3.5rem] font-extrabold text-button drop-shadow-text lg1300:text-[4.2rem] xl1400:text-[4.5rem] xl1500:text-[6rem] xl1900:text-[7rem] xxl3100:text-[12rem] xxl3100:drop-shadow-textlg'>
          Predict and Win
        </h1>
