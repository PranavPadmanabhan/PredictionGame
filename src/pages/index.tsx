    ...
    <div className='relative flex h-screen w-screen flex-col items-center justify-start overflow-hidden bg-backgroundColor pt-[13vh] md:pt-[10vh] lg:justify-center lg:pt-0'>
      ...
      <div className='z-[100] flex h-[40%] w-full flex-col items-center justify-center px-[5%] lg:h-[50%] lg:items-start xxl3100:px-[200px]'>
        ...
        <button
          ...
          className={`${styles.start} h-[48px] w-[60%] max-w-[230px] rounded-[55px] bg-button font-poppins text-[0.9rem] text-white md:h-[50px] md:max-w-[250px] md:text-[1.2rem] lg:h-[40px] lg:w-[30%] lg:max-w-[150px] lg:text-[1rem] xl1400:h-[50px] xl1400:max-w-[180px] xl1400:text-[1.1rem] xxl3100:h-[100px] xxl3100:max-w-[400px] xxl3100:text-[2.5rem]`}
        >
          Start predicting
        </button>
      </div>
