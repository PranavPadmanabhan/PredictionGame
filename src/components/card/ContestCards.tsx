...
const ContestCards = ({
  ...
  return (
    ...
    >
        ...
        >
          ...
          <h1
            className={`font-poppins ${
              predicted
                ? 'text-[1rem] sm:text-[1.1rem] lg:text-[0.95rem] xl1500:text-[1.1rem] xl2300:text-[1.7rem] xxl3100:text-[1.8rem]'
                : 'text-[1rem] sm:text-[1.1rem] lg:text-[0.95rem] xl1500:text-[1.2rem] xl2300:text-[2rem] xxl3100:text-[2.4rem]'
            } font-[700] text-white `}
          >
            {From}
          </h1>
        ...
        <div className='flex h-full max-h-[80px] min-h-[65px] w-[48%] items-center justify-between bg-transparent pr-[7px] pl-[5%] lg:pl-[3%] lg1300:pl-[6%] xl1400:pl-[5%] xl1500:pr-[11px] xl2300:pl-[4%] xxl3100:pr-[17px]'>
          <h1
            className={`font-poppins ${
              predicted
                ? 'text-[1rem] sm:text-[1.1rem] lg:text-[0.95rem] xl1500:text-[1.1rem] xl2300:text-[1.7rem] xxl3100:text-[1.8rem]'
                : 'text-[1rem] sm:text-[1.1rem] lg:text-[0.95rem] xl1500:text-[1.3rem] xl2300:text-[2rem] xxl3100:text-[2.4rem]'
            } font-[700] text-white `}
          >
            {To}
          </h1>
      ...
      <div
        className={`my-4 flex h-[10%] w-full flex-col items-start justify-start pl-4 sm:my-5 lg:my-3 xl1400:my-4 xl1900:my-5 xl2300:my-7
          xxl3100:pl-10`}
      >
        <span
          className={`${
        ...
        <div className='flex min-h-[25px] w-[90%] items-center justify-between xxl3100:min-h-[80px]  '>
          ...
          <div className='flex h-full w-auto items-center justify-end gap-x-1 pr-1 '>
            ...
            <span className='font-poppins text-[0.8rem] font-[300] text-white sm:text-[0.9rem] xl1400:ml-3 xl1400:text-[0.93rem] xl1900:text-[0.96rem] xl2300:text-[1.4rem] xxl3100:mr-5 xxl3100:text-[0.8vw]'>
              {numberOfPredictions}/{maxPlayers}
            </span>
          </div>
        </div>
        <div
          style={{
            padding: numberOfPredictions < 5 ? 5 - numberOfPredictions + 1 : 1,
          }}
          className='my-2 flex h-[12px]  w-[85%] items-center justify-start self-center rounded-[30px] bg-white p-[1px] sm:my-3 sm:h-[15px] lg:my-1 lg:min-h-[15px] xl1400:min-h-[18px] xl1600:min-h-[18px] xl1900:my-3 xl1900:min-h-[17px] xl2300:my-6 xl2300:min-h-[24px] xxl3100:my-3 xxl3100:min-h-[30px] xxl3100:p-[5px] '
        >
          <div
            style={{
              width:
